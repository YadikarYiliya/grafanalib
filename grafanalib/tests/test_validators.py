...
# ✅ Replace attr.Attribute with a Pydantic model
class AttributeModel(BaseModel):
    """Pydantic replacement for attr.Attribute"""
    name: str = "x"
    default: None = None
    repr: bool = True
    eq: bool = True
...
def create_attribute():
    """Creates a Pydantic attribute-like object for testing."""
    return AttributeModel()

# ✅ Tests remain unchanged, except for calling create_attribute() correctly
